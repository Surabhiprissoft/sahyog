...
class UserRepository {
  ...
  Future<SingleResponse<FeeStatusResponseModel>> getFeeData(int userId) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final fees = await apiBaseHelper.get(
          AppConstants.FEESTATUS + userId.toString());

      // Parse the response JSON into a SingleResponse object
      SingleResponse<FeeStatusResponseModel> feeResponse = SingleResponse
          .fromJson(
          fees,
  ...
  Future<SingleResponse<LoginResponseModel>> checkLogin(
      LoginRequestModel loginRequest) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final user = await apiBaseHelper.postWithoutToken(
          AppConstants.LOGIN, loginRequest.toJson());

      // Parse the response JSON into a SingleResponse object
      SingleResponse<LoginResponseModel> loginResponse = SingleResponse
          .fromJson(
          user,
  ...
  Future<TrainerTraineeResponseModel> markFeeStatus(
      MarkFeeStatusRequestModel requestModel) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final feeUpdate = await apiBaseHelper.put(
          AppConstants.MARKFEE, requestModel.toJson());
  ...
  Future<TrainerTraineeResponseModel> addTrainer(
      AddTrainerRequestModel addTrainerRequestModel) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final trainertrainee = await apiBaseHelper.post(
          AppConstants.ADDTRAINER, addTrainerRequestModel.toJson());
  ...
  Future<TrainerTraineeResponseModel> trainerSelfRegistration(
      AddTrainerRequestModel addTrainerRequestModel) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final trainertrainee = await apiBaseHelper.postWithoutToken(
          AppConstants.SELFREGISTERED, addTrainerRequestModel.toJson());
      return TrainerTraineeResponseModel.fromJson(trainertrainee);
    } catch (error) {
      // Handle any errors that occur during the API call
  ...
  Future<TrainerTraineeResponseModel> addTrainee(
      AddTraineeRequestModel addTraineeRequestModel) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final trainertrainee = await apiBaseHelper.post(
          AppConstants.ADDTRAINEE, addTraineeRequestModel.toJson());
      return TrainerTraineeResponseModel.fromJson(trainertrainee);
    } catch (error) {
      // Handle any errors that occur during the API call
      print('Error occurred while checking login: $error');
  ...
  Future<TrainerTraineeResponseModel> traineeSelfRegistration(
      AddTraineeRequestModel addTraineeRequestModel) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final trainertrainee = await apiBaseHelper.postWithoutToken(
          AppConstants.SELFREGISTERED, addTraineeRequestModel.toJson());
      return TrainerTraineeResponseModel.fromJson(trainertrainee);
    } catch (error) {
      // Handle any errors that occur during the API call
      print('Error occurred while checking login: $error');
  ...
  Future<ChangePasswordResponseModel> ChangeUserPassword(
    ...
    try {
      // Make an asynchronous API call to fetch the login response
      final changePassword = await apiBaseHelper.patch(
          AppConstants.UPDATEPASSWORD, changePasswordRequestModel.toJson());
  ...
  Future<ChangePasswordResponseModel> ForgotUserPassword(
      ForgotPasswordRequestModel forgotPasswordRequestModel) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final forgotPassword = await apiBaseHelper.patchWithoutToken(
          AppConstants.FORGOTPASSWORD, forgotPasswordRequestModel.toJson());
  ...
  Future<ListResponse<TrainerListResponseModel>> getTrainerList() async {
    try {
      ...
      // Parse the response JSON into a SingleResponse object
      ListResponse<TrainerListResponseModel> trainerListResponse = ListResponse
          .fromJson(
          trainers,
  ...
  Future<
      ListResponse<TrainerListResponseModel>> getUnApprovedTrainerList() async {
    try {
      // Make an asynchronous API call to fetch the login response
      final unApprovedTrainers = await apiBaseHelper.get(
          AppConstants.UNAPPROVEDRTAINERLIST);
  ...
  Future<ListResponse<TraineeListResponseModel>> getTraineeList() async {
    try {
      ...
      // Parse the response JSON into a SingleResponse object
      ListResponse<TraineeListResponseModel> traineeListResponse = ListResponse
          .fromJson(
          trainees,
  ...
  Future<
      ListResponse<TraineeListResponseModel>> getUnApprovedTraineeList() async {
    try {
      // Make an asynchronous API call to fetch the login response
      final unApprovedTrainees = await apiBaseHelper.get(
          AppConstants.UNAPPROVEDTRAINEELIST);
  ...
  Future<TrainerTraineeResponseModel> actionOnRegistrationRequest(
      RegistrationUpdateRequestModel registrationRequest, int userId) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final response = await apiBaseHelper.patch(
          "approveuser/$userId/", registrationRequest.toJson());
  ...
  Future<TrainerTraineeResponseModel> updateTrainerData(
      UpdateTrainerRequestModel trainerUpdateRequest, int userId) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final response = await apiBaseHelper.put(
          "updateuser/$userId", trainerUpdateRequest.toJson());
      return TrainerTraineeResponseModel.fromJson(response);
    } catch (error) {
      // Handle any errors that occur during the API call
      print('Error occurred while checking login: $error');
  ...
  Future<TrainerTraineeResponseModel> updateTraineeData(
      UpdateTraineeDataRequestModel traineeUpdateRequest, int userId) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final response = await apiBaseHelper.put(
          "updateuser/$userId", traineeUpdateRequest.toJson());
      return TrainerTraineeResponseModel.fromJson(response);
    } catch (error) {
      // Handle any errors that occur during the API call
      print('Error occurred while checking login: $error');
  ...
  Future<SingleResponse<
      AdminDashboardResponseModel>> getAdminDashboardData() async {
    try {
      // Make an asynchronous API call to fetch the login response
      final details = await apiBaseHelper.get(AppConstants.ADMINDASHBOARD);

      // Parse the response JSON into a SingleResponse object
      SingleResponse<AdminDashboardResponseModel> detailList = SingleResponse
          .fromJson(
          details,
  ...
  Future<SingleResponse<TraineeDashboardResponseModel>> getTraineeDashboardData(
      int userId) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final details = await apiBaseHelper.get(
          AppConstants.TRAINEEDASHBOARD + userId.toString());

      // Parse the response JSON into a SingleResponse object
      SingleResponse<TraineeDashboardResponseModel> detailList = SingleResponse
          .fromJson(
          details,
  ...
  Future<ListResponse<TimeSlotResponseModel>> getTimeSlots(String url) async {
    try {
      ...
      // Parse the response JSON into a SingleResponse object
      ListResponse<TimeSlotResponseModel> timeslotresponse = ListResponse
          .fromJson(
          user,
  ...
  Future<TrainerTraineeResponseModel> scheduleTrainer(
      List<ScheduleTrainerRequestModel> scheduleTrainerRequestModels) async {
    try {
      ...
      final trainertrainee = await apiBaseHelper.postScheduleTrainers(
          AppConstants.SCHEDULETRAINERS, scheduleTrainerRequestModels);
  ...
  Future<SingleResponse<TrainerDashboardResponseModel>> getTrainerDashboardData(
      int userId, String currentDate) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final details = await apiBaseHelper.get(
          AppConstants.TRAINERDASHBOARD + userId.toString() + "/" +
              currentDate);

      // Parse the response JSON into a SingleResponse object
      SingleResponse<TrainerDashboardResponseModel> detailList = SingleResponse
          .fromJson(
          details,
  ...
  Future<TrainerTraineeResponseModel> deletSchedule(
      DeleteTraineeRequestModel deleteTraineeRequestModel) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final trainertrainee = await apiBaseHelper.post(
          AppConstants.DELETESCHEDULE, deleteTraineeRequestModel.toJson());
      return TrainerTraineeResponseModel.fromJson(trainertrainee);
    } catch (error) {
      // Handle any errors that occur during the API call
      print('Error occurred while checking login: $error');
  ...
  Future<UpdateAttendanceResponseModel> updateAttendance(
      UpdateAttendanceRequestModel updateAttendanceRequestModel) async {
    try {
      // Make an asynchronous API call to fetch the login response
      final updateattendance = await apiBaseHelper.post(
          AppConstants.UPDATEATTENDANCE, updateAttendanceRequestModel.toJson());
      return UpdateAttendanceResponseModel.fromJson(updateattendance);
    } catch (error) {
      // Handle any errors that occur during the API call
      print('Error occurred while checking login: $error');
      throw error;
